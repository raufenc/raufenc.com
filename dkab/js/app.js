...
import { getGradeInfo, loadGradeEssentials, loadChapterContent, loadGlossary, loadData } from './data-loader.js?v=11';
...
import { renderClassSelector } from './components/class-selector.js?v=11';
import { renderUnitList } from './components/unit-list.js?v=11';
import { renderChapterView } from './components/chapter-view.js?v=11';
import { renderGlossary } from './components/glossary.js?v=11';
import { renderProgressDashboard } from './components/progress-dashboard.js?v=11';
import { showConfetti, showXpPopup, showLevelUp } from './components/effects.js?v=11';
// 360° Ekosistem bilesenleri
import { renderLearningPath } from './components/learning-path.js?v=11';
import { renderAssessment } from './components/assessment.js?v=11';
import { renderGoals } from './components/goals.js?v=11';
import { renderHabits } from './components/habits.js?v=11';
// Faz 3 — Isbirlikci
import { renderLeaderboard } from './components/leaderboard.js?v=11';
import { renderKnowledgeWall } from './components/knowledge-wall.js?v=11';
import { renderChallenges } from './components/challenges.js?v=11';
// Faz 4 — Kultur + Rehberlik
import { renderStudyGuide } from './components/study-guide.js?v=11';
import { renderHicriTakvim } from './components/hicri-takvim.js?v=11';
import { renderBehaviorTracker } from './components/behavior-tracker.js?v=11';
import { renderAnnualReport } from './components/annual-report.js?v=11';
