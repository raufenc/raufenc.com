...
import { getGradeInfo, loadGradeEssentials, loadChapterContent, loadGlossary, loadData } from './data-loader.js?v=12';
import { renderHeader } from './components/header.js?v=12';
import { renderSidebar } from './components/sidebar.js?v=12';
import { renderHome } from './components/home.js?v=12';
import { renderClassSelector } from './components/class-selector.js?v=12';
import { renderUnitList } from './components/unit-list.js?v=12';
import { renderChapterView } from './components/chapter-view.js?v=12';
import { renderGlossary } from './components/glossary.js?v=12';
import { renderProgressDashboard } from './components/progress-dashboard.js?v=12';
import { showConfetti, showXpPopup, showLevelUp } from './components/effects.js?v=12';
// 360° Ekosistem bilesenleri
import { renderLearningPath } from './components/learning-path.js?v=12';
import { renderAssessment } from './components/assessment.js?v=12';
import { renderGoals } from './components/goals.js?v=12';
import { renderHabits } from './components/habits.js?v=12';
// Faz 3 — Isbirlikci
import { renderLeaderboard } from './components/leaderboard.js?v=12';
import { renderKnowledgeWall } from './components/knowledge-wall.js?v=12';
import { renderChallenges } from './components/challenges.js?v=12';
// Faz 4 — Kultur + Rehberlik
import { renderStudyGuide } from './components/study-guide.js?v=12';
import { renderHicriTakvim } from './components/hicri-takvim.js?v=12';
import { renderBehaviorTracker } from './components/behavior-tracker.js?v=12';
import { renderAnnualReport } from './components/annual-report.js?v=12';
