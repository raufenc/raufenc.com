...
window.YH = (function () {
  ...
  const bigfive = {
    O:  { key:"O",  name:"Açıklık & Merak", emoji:"🎨", poles:["Pratik-Somut","Meraklı-Yaratıcı"], strengths:["Yaratıcılık","Merak"],
    ...
    C:  { key:"C",  name:"Sorumluluk & Düzen", emoji:"🎯", poles:["Esnek-Spontane","Planlı-Düzenli"], strengths:["Disiplin","Güvenilirlik"],
    ...
    E:  { key:"E",  name:"Dışadönüklük & Enerji", emoji:"⚡", poles:["Sakin-Odaklı","Enerjik-Sosyal"], strengths:["İletişim","Enerji"],
    ...
    A:  { key:"A",  name:"Uyumluluk & Sıcaklık", emoji:"💛", poles:["Bağımsız-Eleştirel","Şefkatli-Uyumlu"], strengths:["Empati","Takım ruhu"],
    ...
    N:  { key:"ES", name:"Duygusal Denge & Sükûnet", emoji:"🧘", fromN:true, poles:["Hassas-Tepkisel","Sakin-Dengeli"], strengths:["Soğukkanlılık","Dayanıklılık"],
