...
window.YH = (function () {
  ...
  const bigfive = {
    O:  { key:"O",  name:"Açıklık & Merak", orig:"Openness", emoji:"🎨", poles:["Pratik-Somut","Meraklı-Özgün"], strengths:["Hayal gücü","Merak"],
  ...
  const turns = [
    ...
    { id:2, name:"Stüdyo & Topluluk",    emoji:"🎨", teaser:"Üretken ve insancıl yanını yokluyoruz." },
  ...
  const items = [
    ...
    { id:"O_4", turn:4, format:"likert", scale:"bigfive", layer:"bigfive", dim:"O", reverse:true, text:"Alışılmış, denenmiş yolları yeni şeyler denemeye tercih ederim." },
    { id:"A_4", turn:4, format:"likert", scale:"bigfive", layer:"bigfive", dim:"A", text:"Bir anlaşmazlıkta uzlaşma ve orta yol bulmaya çalışırım." },
  ...
  const archetypes = [
    ...
    { id:5,  ad:"Özgün Kâşif",        emoji:"🎨", hex:"#8E44AD", primary:"A", def:"Hayal gücün hiç durmuyor; yeni fikirler ve farklı bakışlar senin doğal süper gücün." },
    ...
    { id:15, ad:"Sanat-Elçi",         emoji:"🌈", hex:"#AF7AC5", special:"AS", def:"Üretkenliğini insanlara dokunmak için kullanıyorsun. Hem üretiyor hem iyileştiriyorsun." },
  ...
  const archetypeChat = {
    ...
    5:"Aklındaki bir fikri hayata geçirsen, ilk neyi ortaya koymak isterdin?",
    ...
    15:"Üretkenliğini birine iyilik için kullandığın bir an oldu mu?",
  ...
  const careers = [
    ...
    { ad:"Elektrik-Elektronik Mühendisliği", kod:"IRC", puanTuru:"SAY", jobZone:4, trend:true, ornek:["Elektronik mühendisi","Gömülü sistem geliştirici"] },
    ...
    { ad:"Dijital Oyun Tasarımı", kod:"AIE", puanTuru:"SAY/SÖZ/Yetenek", jobZone:4, trend:true, ornek:["Oyun tasarımcısı","Seviye tasarımcısı"],
      why:"Hikâye, estetik, sistem düşüncesi ve teknik üretimi bir araya getirir.",
      next:"Kâğıt üstünde küçük bir oyun kuralı tasarla veya basit bir oyun prototipi hazırla.",
    ...
    { ad:"Dil ve Konuşma Terapisi", kod:"SIR", puanTuru:"SAY", jobZone:5, trend:true, ornek:["Dil ve konuşma terapisti"],
  ...
  const codeMessages = {
    ...
    ASE:"Hem üretken hem insan odaklısın; dijital içerik ve iletişim yükselen alanlar.",
