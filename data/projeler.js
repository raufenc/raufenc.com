...
var PROJELER = [
  ...
  { emoji: '\u{1F333}', title: 'Kelime Aileleri', desc: 'Konuk, komşu ve konuşmak aynı kökten. Tele ile fon birleşince telefon olur. Dört kutu, 144 kelime ailesi, 720 kelime — yedişer oyunla keşfet.', tag: 'Oyun', href: '/kelime-aileleri/', kategori: 'dil', featured: true },
  ...
  { emoji: '\u{1F3AE}', title: 'İHO 7. Sınıf Arapça Oyunları', desc: 'Arapça dersi sıkıcı olmak zorunda değil. 44 oyunla kelime, cümle ve gramer — sınıfça yarışın!', tag: 'Oyun', href: '/7sinif/', kategori: 'sinif' },
